...
/**
 * is_chain - only test if current character in buffer is a chain delimeter
...
/**
 * check_chain - checks if based on last status we should continue chaining
 * @info: parameter structure
 * @buf: character buffer
 * @p: the address of current position in buffer
 ...
 * @new: the new string
 *
 * Return: 1 if replaced 1, otherwise 0
 */
