...
/**
 * print_error - prints err messages
...
/**
 * print_d - function prints a base 10 decimal (integer) number
 * @input: input
 * @fd: the fd to write to
 * Return: number of printed chrs
 */
...
/**
 * convert_number - converter fxn, an itoa clone
 * @num: the number
 * @base: the base
...
/**
 * remove_comments - first instance of '#' is replaced with '\0' by function
