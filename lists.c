...
/**
 * add_node - appends node to beginning of the list
 * @head: pointer address to head node
 * @str: node structure field
 * @num: history used node index
 *
 * Return: list size
 */
...
/**
 * print_list_str - prints only str element of the list_t linked list
...
/**
 * free_list - frees all nodes of lists
